...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('bulkproducts.handleImport') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <!-- Import bulkproducts -->
                <div class="card mb-4 mb-xl-0">
                    <div class="card-header">Import Product Bulk Material</div>
                    <div class="card-body">
                        <!-- Import bulkproduct input -->
