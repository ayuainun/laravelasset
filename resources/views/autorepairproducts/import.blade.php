...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('autorepairproducts.handleImport') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <!-- Import autorepairproducts -->
                <div class="card mb-4 mb-xl-0">
                    <div class="card-header">Import Product Automation</div>
                    <div class="card-body">
                        <!-- Import autorepairproduct input -->
