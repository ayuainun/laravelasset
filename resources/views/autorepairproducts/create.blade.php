...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('autorepairproducts.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_assetID') is-invalid @enderror" id="autorepairproduct_assetID" name="autorepairproduct_assetID" type="text" placeholder="" value="{{ old('autorepairproduct_assetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_newassetID') is-invalid @enderror" id="autorepairproduct_newassetID" name="autorepairproduct_newassetID" type="text" placeholder="" value="{{ old('autorepairproduct_newassetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_serial') is-invalid @enderror" id="autorepairproduct_serial" name="autorepairproduct_serial" type="text" placeholder="" value="{{ old('autorepairproduct_serial') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('autorepairproduct_datein') is-invalid @enderror" name="autorepairproduct_datein" id="autorepairproduct_datein" type="date" value="{{ old('autorepairproduct_datein') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_transfer') is-invalid @enderror" id="autorepairproduct_transfer" name="autorepairproduct_transfer" type="text" placeholder="" value="{{ old('autorepairproduct_transfer') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_reser') is-invalid @enderror" id="autorepairproduct_reser" name="autorepairproduct_reser" type="text" placeholder="" value="{{ old('autorepairproduct_reser') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_origin') is-invalid @enderror" id="autorepairproduct_origin" name="autorepairproduct_origin" type="text" placeholder="" value="{{ old('autorepairproduct_origin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_sdvin') is-invalid @enderror" id="autorepairproduct_sdvin" name="autorepairproduct_sdvin" type="text" placeholder="" value="{{ old('autorepairproduct_sdvin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_sdvout') is-invalid @enderror" id="autorepairproduct_sdvout" name="autorepairproduct_sdvout" type="text" placeholder="" value="{{ old('autorepairproduct_sdvout') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_station') is-invalid @enderror" id="autorepairproduct_station" name="autorepairproduct_station" type="text" placeholder="" value="{{ old('autorepairproduct_station') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_requestor') is-invalid @enderror" id="autorepairproduct_requestor" name="autorepairproduct_requestor" type="text" placeholder="" value="{{ old('autorepairproduct_requestor') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_project') is-invalid @enderror" id="autorepairproduct_project" name="autorepairproduct_project" type="text" placeholder="" value="{{ old('autorepairproduct_project') }}" autocomplete="off"/>
                            ...
                            <!-- Form Group (date Out) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="autorepairproduct_dateout">Date Out</span></label>
                                <input class="form-control form-control-solid example-date-input @error('autorepairproduct_dateout') is-invalid @enderror" name="autorepairproduct_dateout" id="autorepairproduct_dateout" type="date" value="{{ old('autorepairproduct_dateout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                <label class="small my-1" for="autorepairproduct_dateoffshore">Date to offshore</span></label>
                                <input class="form-control form-control-solid example-date-input @error('autorepairproduct_dateoffshore') is-invalid @enderror" name="autorepairproduct_dateoffshore" id="autorepairproduct_dateoffshore" type="date" value="{{ old('autorepairproduct_dateoffshore') }}" autocomplete="off" />
                            ...
                            <!-- Form Group (autorepairproduct transfer offshore) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="autorepairproduct_tfoffshore">Material transfer to offshore</label>
                                <input class="form-control form-control-solid @error('autorepairproduct_tfoffshore') is-invalid @enderror" id="autorepairproduct_tfoffshore" name="autorepairproduct_tfoffshore" type="text" placeholder="" value="{{ old('autorepairproduct_tfoffshore') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_curloc') is-invalid @enderror" id="autorepairproduct_curloc" name="autorepairproduct_curloc" type="text" placeholder="" value="{{ old('autorepairproduct_curloc') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_stockout') is-invalid @enderror" id="autorepairproduct_stockout" name="autorepairproduct_stockout" type="text" placeholder="" value="{{ old('autorepairproduct_stockout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="autorepairproduct_uom">UOM</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('autorepairproduct_targetpdn') is-invalid @enderror" name="autorepairproduct_targetpdn" id="autorepairproduct_targetpdn" type="date" value="{{ old('autorepairproduct_targetpdn') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_csrelease') is-invalid @enderror" id="autorepairproduct_csrelease" name="autorepairproduct_csrelease" type="text" placeholder="" value="{{ old('autorepairproduct_csrelease') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_csnumber') is-invalid @enderror" id="autorepairproduct_csnumber" name="autorepairproduct_csnumber" type="text" placeholder="" value="{{ old('autorepairproduct_csnumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_cenumber') is-invalid @enderror" id="autorepairproduct_cenumber" name="autorepairproduct_cenumber" type="text" placeholder="" value="{{ old('autorepairproduct_cenumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_ronumber') is-invalid @enderror" id="autorepairproduct_ronumber" name="autorepairproduct_ronumber" type="text" placeholder="" value="{{ old('autorepairproduct_ronumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('autorepairproduct_startdate') is-invalid @enderror" name="autorepairproduct_startdate" id="autorepairproduct_startdate" type="date" value="{{ old('autorepairproduct_startdate') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('autorepairproduct_enddate') is-invalid @enderror" name="autorepairproduct_enddate" id="autorepairproduct_enddate" type="date" value="{{ old('autorepairproduct_enddate') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_price') is-invalid @enderror" id="autorepairproduct_price" name="autorepairproduct_price" type="text" placeholder="" value="{{ old('autorepairproduct_price') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('autorepairproduct_remark') is-invalid @enderror" id="autorepairproduct_remark" name="autorepairproduct_remark" type="text" placeholder="" value="{{ old('autorepairproduct_remark') }}" autocomplete="off"/>
