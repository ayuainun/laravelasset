                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_assetID') is-invalid @enderror" id="product_assetID" name="product_assetID" type="text" placeholder="" value="{{ old('product_assetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_newassetID') is-invalid @enderror" id="product_newassetID" name="product_newassetID" type="text" placeholder="" value="{{ old('product_newassetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_equip') is-invalid @enderror" id="product_equip" name="product_equip" type="text" placeholder="" value="{{ old('product_equip') }}" autocomplete="off"/>
                                @error('product_equip')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_type') is-invalid @enderror" id="product_type" name="product_type" type="text" placeholder="" value="{{ old('product_type') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_end') is-invalid @enderror" id="product_end" name="product_end" type="text" placeholder="" value="{{ old('product_end') }}" autocomplete="off"/>
                           ...
                           <!-- Form Group (type of product size) -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_size') is-invalid @enderror" id="product_size" name="product_size" type="text" placeholder="" value="{{ old('product_size') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_rating') is-invalid @enderror" id="product_rating" name="product_rating" type="text" placeholder="" value="{{ old('product_rating') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_brand') is-invalid @enderror" id="product_brand" name="product_brand" type="text" placeholder="" value="{{ old('product_brand') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_valvemodel') is-invalid @enderror" id="product_valvemodel" name="product_valvemodel" type="text" placeholder="" value="{{ old('product_valvemodel') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_serial') is-invalid @enderror" id="product_serial" name="product_serial" type="text" placeholder="" value="{{ old('product_serial') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_condi') is-invalid @enderror" id="product_condi" name="product_condi" type="text" placeholder="" value="{{ old('product_condi') }}" autocomplete="off"/>
                                    <option selected="" disabled="">Select a valve condition:</option>
                                    <option value="" {{ old('product_condi') === null ? 'selected' : '' }}>N/A</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_actbrand') is-invalid @enderror" id="product_actbrand" name="product_actbrand" type="text" placeholder="" value="{{ old('product_actbrand') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_acttype') is-invalid @enderror" id="product_acttype" name="product_acttype" type="text" placeholder="" value="{{ old('product_acttype') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_actsize') is-invalid @enderror" id="product_actsize" name="product_actsize" type="text" placeholder="" value="{{ old('product_actsize') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_fail') is-invalid @enderror" id="product_fail" name="product_fail" type="text" placeholder="" value="{{ old('product_fail') }}" autocomplete="off"/>
                                @error('product_fail')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_actcond') is-invalid @enderror" id="product_actcond" name="product_actcond" type="text" placeholder="" value="{{ old('product_actcond') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_posbrand') is-invalid @enderror" id="product_posbrand" name="product_posbrand" type="text" placeholder="" value="{{ old('product_posbrand') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_posmodel') is-invalid @enderror" id="product_posmodel" name="product_posmodel" type="text" placeholder="" value="{{ old('product_posmodel') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_inputsignal') is-invalid @enderror" id="product_inputsignal" name="product_inputsignal" type="text" placeholder="" value="{{ old('product_inputsignal') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_poscond') is-invalid @enderror" id="product_poscond" name="product_poscond" type="text" placeholder="" value="{{ old('product_poscond') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_other') is-invalid @enderror" id="product_other" name="product_other" type="text" placeholder="" value="{{ old('product_other') }}" autocomplete="off"/>
                                @error('product_other')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('product_datein') is-invalid @enderror" name="product_datein" id="product_datein" type="date" value="{{ old('product_datein') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_transfer') is-invalid @enderror" id="product_transfer" name="product_transfer" type="text" placeholder="" value="{{ old('product_transfer') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_reser') is-invalid @enderror" id="product_reser" name="product_reser" type="text" placeholder="" value="{{ old('product_reser') }}" autocomplete="off"/>
                                @error('product_reser')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_origin') is-invalid @enderror" id="product_origin" name="product_origin" type="text" placeholder="" value="{{ old('product_origin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_sdvin') is-invalid @enderror" id="product_sdvin" name="product_sdvin" type="text" placeholder="" value="{{ old('product_sdvin') }}" autocomplete="off"/>
                                @error('product_sdvin')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_sdvout') is-invalid @enderror" id="product_sdvout" name="product_sdvout" type="text" placeholder="" value="{{ old('product_sdvout') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_station') is-invalid @enderror" id="product_station" name="product_station" type="text" placeholder="" value="{{ old('product_station') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_requestor') is-invalid @enderror" id="product_requestor" name="product_requestor" type="text" placeholder="" value="{{ old('product_requestor') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_project') is-invalid @enderror" id="product_project" name="product_project" type="text" placeholder="" value="{{ old('product_project') }}" autocomplete="off"/>
                            ...
                            <!-- Form Group (date Out) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="product_dateout">Date Out</span></label>
                                <input class="form-control form-control-solid example-date-input @error('product_dateout') is-invalid @enderror" name="product_dateout" id="product_dateout" type="date" value="{{ old('product_dateout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                <label class="small my-1" for="product_dateoffshore">Date to offshore</span></label>
                                <input class="form-control form-control-solid example-date-input @error('product_dateoffshore') is-invalid @enderror" name="product_dateoffshore" id="product_dateoffshore" type="date" value="{{ old('product_dateoffshore') }}" autocomplete="off"/>
                            ...
                            <!-- Form Group (product transfer offshore) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="product_tfoffshore">Material transfer to offshore</label>
                                <input class="form-control form-control-solid @error('product_tfoffshore') is-invalid @enderror" id="product_tfoffshore" name="product_tfoffshore" type="text" placeholder="" value="{{ old('product_tfoffshore') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_stockout') is-invalid @enderror" id="product_stockout" name="product_stockout" type="text" placeholder="" value="{{ old('product_stockout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('product_uom') is-invalid @enderror" id="product_uom" name="product_uom" type="text" placeholder="" value="{{ old('product_uom') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('product_targetpdn') is-invalid @enderror" name="product_targetpdn" id="product_targetpdn" type="date" value="{{ old('product_targetpdn')}}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_csrelease') is-invalid @enderror" id="product_csrelease" name="product_csrelease" type="text" placeholder="" value="{{ old('product_csrelease') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_csnumber') is-invalid @enderror" id="product_csnumber" name="product_csnumber" type="text" placeholder="" value="{{ old('product_csnumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_cenumber') is-invalid @enderror" id="product_cenumber" name="product_cenumber" type="text" placeholder="" value="{{ old('product_cenumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_ronumber') is-invalid @enderror" id="product_ronumber" name="product_ronumber" type="text" placeholder="" value="{{ old('product_ronumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small my-1" for="product_startdate">Start Date</span></label>
                                <input class="form-control form-control-solid example-date-input @error('product_startdate') is-invalid @enderror" name="product_startdate" id="product_startdate" type="date" value="{{ old('product_startdate') }}" autocomplete="off"/>
                            ...
                            <!-- Form Group (end Date) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="product_enddate">End Date</span></label>
                                <input class="form-control form-control-solid example-date-input @error('product_enddate') is-invalid @enderror" name="product_enddate" id="product_enddate" type="date" value="{{ old('product_enddate') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_price') is-invalid @enderror" id="product_price" name="product_price" type="text" placeholder="" value="{{ old('product_price') }}" autocomplete="off"/>
                                @error('product_price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('product_remark') is-invalid @enderror" id="product_remark" name="product_remark" type="text" placeholder="" value="{{ old('product_remark') }}" autocomplete="off"/>
