...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('repairproducts.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_assetID') is-invalid @enderror" id="repairproduct_assetID" name="repairproduct_assetID" type="text" placeholder="" value="{{ old('repairproduct_assetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_newassetID') is-invalid @enderror" id="repairproduct_newassetID" name="repairproduct_newassetID" type="text" placeholder="" value="{{ old('repairproduct_newassetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_equip') is-invalid @enderror" id="repairproduct_equip" name="repairproduct_equip" type="text" placeholder="" value="{{ old('repairproduct_equip') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_unit') is-invalid @enderror" id="repairproduct_unit" name="repairproduct_unit" type="text" placeholder="" value="{{ old('repairproduct_unit') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_end') is-invalid @enderror" id="repairproduct_end" name="repairproduct_end" type="text" placeholder="" value="{{ old('repairproduct_end') }}" autocomplete="off"/>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-solid @error('repairproduct_size') is-invalid @enderror" id="repairproduct_size" name="repairproduct_size" type="text" placeholder="" value="{{ old('repairproduct_size') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_rating') is-invalid @enderror" id="repairproduct_rating" name="repairproduct_rating" type="text" placeholder="" value="{{ old('repairproduct_rating') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_brand') is-invalid @enderror" id="repairproduct_brand" name="repairproduct_brand" type="text" placeholder="" value="{{ old('repairproduct_brand') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_valvemodel') is-invalid @enderror" id="repairproduct_valvemodel" name="repairproduct_valvemodel" type="text" placeholder="" value="{{ old('repairproduct_valvemodel') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_serial') is-invalid @enderror" id="repairproduct_serial" name="repairproduct_serial" type="text" placeholder="" value="{{ old('repairproduct_serial') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_condi') is-invalid @enderror" id="repairproduct_condi" name="repairproduct_condi" type="text" placeholder="" value="{{ old('repairproduct_condi') }}" autocomplete="off"/>
                                    <option selected="" disabled="">Select a valve condition:</option>
                                    <option value="" {{ old('repairproduct_condi') === null ? 'selected' : '' }}>N/A</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_actbrand') is-invalid @enderror" id="repairproduct_actbrand" name="repairproduct_actbrand" type="text" placeholder="" value="{{ old('repairproduct_actbrand') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_acttype') is-invalid @enderror" id="repairproduct_acttype" name="repairproduct_acttype" type="text" placeholder="" value="{{ old('repairproduct_acttype') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_actsize') is-invalid @enderror" id="repairproduct_actsize" name="repairproduct_actsize" type="text" placeholder="" value="{{ old('repairproduct_actsize') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_fail') is-invalid @enderror" id="repairproduct_fail" name="repairproduct_fail" type="text" placeholder="" value="{{ old('repairproduct_fail') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_actcond') is-invalid @enderror" id="repairproduct_actcond" name="repairproduct_actcond" type="text" placeholder="" value="{{ old('repairproduct_actcond') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_posbrand') is-invalid @enderror" id="repairproduct_posbrand" name="repairproduct_posbrand" type="text" placeholder="" value="{{ old('repairproduct_posbrand') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_posmodel') is-invalid @enderror" id="repairproduct_posmodel" name="repairproduct_posmodel" type="text" placeholder="" value="{{ old('repairproduct_posmodel') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_inputsignal') is-invalid @enderror" id="repairproduct_inputsignal" name="repairproduct_inputsignal" type="text" placeholder="" value="{{ old('repairproduct_inputsignal') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_poscond') is-invalid @enderror" id="repairproduct_poscond" name="repairproduct_poscond" type="text" placeholder="" value="{{ old('repairproduct_poscond') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_other') is-invalid @enderror" id="repairproduct_other" name="repairproduct_other" type="text" placeholder="" value="{{ old('repairproduct_other') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('repairproduct_datein') is-invalid @enderror" name="repairproduct_datein" id="repairproduct_datein" type="date" value="{{ old('repairproduct_datein') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_transfer') is-invalid @enderror" id="repairproduct_transfer" name="repairproduct_transfer" type="text" placeholder="" value="{{ old('repairproduct_transfer') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_reser') is-invalid @enderror" id="repairproduct_reser" name="repairproduct_reser" type="text" placeholder="" value="{{ old('repairproduct_reser') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_origin') is-invalid @enderror" id="repairproduct_origin" name="repairproduct_origin" type="text" placeholder="" value="{{ old('repairproduct_origin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_sdvin') is-invalid @enderror" id="repairproduct_sdvin" name="repairproduct_sdvin" type="text" placeholder="" value="{{ old('repairproduct_sdvin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_sdvout') is-invalid @enderror" id="repairproduct_sdvout" name="repairproduct_sdvout" type="text" placeholder="" value="{{ old('repairproduct_sdvout') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_station') is-invalid @enderror" id="repairproduct_station" name="repairproduct_station" type="text" placeholder="" value="{{ old('repairproduct_station') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_requestor') is-invalid @enderror" id="repairproduct_requestor" name="repairproduct_requestor" type="text" placeholder="" value="{{ old('repairproduct_requestor') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_project') is-invalid @enderror" id="repairproduct_project" name="repairproduct_project" type="text" placeholder="" value="{{ old('repairproduct_project') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('repairproduct_dateout') is-invalid @enderror" name="repairproduct_dateout" id="repairproduct_dateout" type="date" value="{{ old('repairproduct_dateout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('repairproduct_dateoffshore') is-invalid @enderror" name="repairproduct_dateoffshore" id="repairproduct_dateoffshore" type="date" value="{{ old('repairproduct_dateoffshore') }}" autocomplete="off" />
                            ...
                            <!-- Form Group (repairproduct transfer offshore) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="repairproduct_tfoffshore">Material transfer to offshore</label>
                                <input class="form-control form-control-solid @error('repairproduct_tfoffshore') is-invalid @enderror" id="repairproduct_tfoffshore" name="repairproduct_tfoffshore" type="text" placeholder="" value="{{ old('repairproduct_tfoffshore') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_curloc') is-invalid @enderror" id="repairproduct_curloc" name="repairproduct_curloc" type="text" placeholder="" value="{{ old('repairproduct_curloc') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_stockin') is-invalid @enderror" id="repairproduct_stockin" name="repairproduct_stockin" type="text" placeholder="" value="{{ old('repairproduct_stockin') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_stockout') is-invalid @enderror" id="repairproduct_stockout" name="repairproduct_stockout" type="text" placeholder="" value="{{ old('repairproduct_stockout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_stockqty') is-invalid @enderror" id="repairproduct_stockqty" name="repairproduct_stockqty" type="text" placeholder="" value="{{ old('repairproduct_stockqty') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_uom') is-invalid @enderror" id="repairproduct_uom" name="repairproduct_uom" type="text" placeholder="" value="{{ old('repairproduct_uom') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('repairproduct_targetpdn') is-invalid @enderror" name="repairproduct_targetpdn" id="repairproduct_targetpdn" type="date" value="{{ old('repairproduct_targetpdn') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_csrelease') is-invalid @enderror" id="repairproduct_csrelease" name="repairproduct_csrelease" type="text" placeholder="" value="{{ old('repairproduct_csrelease') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_csnumber') is-invalid @enderror" id="repairproduct_csnumber" name="repairproduct_csnumber" type="text" placeholder="" value="{{ old('repairproduct_csnumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_cenumber') is-invalid @enderror" id="repairproduct_cenumber" name="repairproduct_cenumber" type="text" placeholder="" value="{{ old('repairproduct_cenumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_ronumber') is-invalid @enderror" id="repairproduct_ronumber" name="repairproduct_ronumber" type="text" placeholder="" value="{{ old('repairproduct_ronumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small my-1" for="repairproduct_startdate">Start Date</label>
                                <input class="form-control form-control-solid example-date-input @error('repairproduct_startdate') is-invalid @enderror" name="repairproduct_startdate" id="repairproduct_startdate" type="date" value="{{ old('repairproduct_startdate') }}" autocomplete="off"/>
                            ...
                            <!-- Form Group (end Date) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="repairproduct_enddate">End Date</label>
                                <input class="form-control form-control-solid example-date-input @error('repairproduct_enddate') is-invalid @enderror" name="repairproduct_enddate" id="repairproduct_enddate" type="date" value="{{ old('repairproduct_enddate') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('repairproduct_status') is-invalid @enderror" id="repairproduct_status" name="repairproduct_status" status="text" placeholder="" value="{{ old('repairproduct_status') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('repairproduct_remark') is-invalid @enderror" id="repairproduct_remark" name="repairproduct_remark" type="text" placeholder="" value="{{ old('repairproduct_remark') }}" autocomplete="off"/>
