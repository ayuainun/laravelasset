...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('partsproducts.update', $partsproduct->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_assetID') is-invalid @enderror" id="partsproduct_assetID" name="partsproduct_assetID" type="text" placeholder="" value="{{ old('partsproduct_assetID', $partsproduct->partsproduct_assetID) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_newassetID') is-invalid @enderror" id="partsproduct_newassetID" name="partsproduct_newassetID" type="text" placeholder="" value="{{ old('partsproduct_newassetID', $partsproduct->partsproduct_newassetID) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_serial') is-invalid @enderror" id="partsproduct_serial" name="partsproduct_serial" type="text" placeholder="" value="{{ old('partsproduct_serial', $partsproduct->partsproduct_serial) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="partsproduct_transfer">Asset Transfer Ref.</label>
                                <input class="form-control form-control-solid @error('partsproduct_transfer') is-invalid @enderror" id="partsproduct_transfer" name="partsproduct_transfer" type="text" placeholder="" value="{{ old('partsproduct_transfer', $partsproduct->partsproduct_transfer) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_reser') is-invalid @enderror" id="partsproduct_reser" name="partsproduct_reser" type="text" placeholder="" value="{{ old('partsproduct_reser', $partsproduct->partsproduct_reser) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_origin') is-invalid @enderror" id="partsproduct_origin" name="partsproduct_origin" type="text" placeholder="" value="{{ old('partsproduct_origin', $partsproduct->partsproduct_origin) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_sdvin') is-invalid @enderror" id="partsproduct_sdvin" name="partsproduct_sdvin" type="text" placeholder="" value="{{ old('partsproduct_sdvin', $partsproduct->partsproduct_sdvin) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_sdvout') is-invalid @enderror" id="partsproduct_sdvout" name="partsproduct_sdvout" type="text" placeholder="" value="{{ old('partsproduct_sdvout', $partsproduct->partsproduct_sdvout) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_station') is-invalid @enderror" id="partsproduct_station" name="partsproduct_station" type="text" placeholder="" value="{{ old('partsproduct_station', $partsproduct->partsproduct_station) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_requestor') is-invalid @enderror" id="partsproduct_requestor" name="partsproduct_requestor" type="text" placeholder="" value="{{ old('partsproduct_requestor', $partsproduct->partsproduct_requestor) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_project') is-invalid @enderror" id="partsproduct_project" name="partsproduct_project" type="text" placeholder="" value="{{ old('partsproduct_project', $partsproduct->partsproduct_project) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('partsproduct_datein') is-invalid @enderror" name="partsproduct_datein" id="partsproduct_datein" type="date" placeholder="" value="{{ old('partsproduct_datein', $partsproduct->partsproduct_datein) }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('partsproduct_dateout') is-invalid @enderror" name="partsproduct_dateout" id="partsproduct_dateout" type="date" placeholder="" value="{{ old('partsproduct_dateout', $partsproduct->partsproduct_dateout) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('partsproduct_dateoffshore') is-invalid @enderror" name="partsproduct_dateoffshore" id="partsproduct_dateoffshore" type="date" value="{{ old('partsproduct_dateoffshore', $partsproduct->partsproduct_dateoffshore) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_tfoffshore') is-invalid @enderror" id="partsproduct_tfoffshore" name="partsproduct_tfoffshore" type="text" placeholder="" value="{{ old('partsproduct_tfoffshore', $partsproduct->partsproduct_tfoffshore) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_curloc') is-invalid @enderror" id="partsproduct_curloc" name="partsproduct_curloc" type="text" placeholder="" value="{{ old('partsproduct_curloc', $partsproduct->partsproduct_curloc) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('partsproduct_targetpdn') is-invalid @enderror" name="partsproduct_targetpdn" id="partsproduct_targetpdn" type="date" value="{{ old('partsproduct_targetpdn', $partsproduct->partsproduct_targetpdn) }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_stockout') is-invalid @enderror" id="partsproduct_stockout" name="partsproduct_stockout" type="text" placeholder="" value="{{ old('partsproduct_stockout', $partsproduct->partsproduct_stockout) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="partsproduct_uom" >UOM</label>
                                    <select class="form-control form-control-solid @error('partsproduct_uom') is-invalid @enderror" id="partsproduct_uom" name="partsproduct_uom" type="text" placeholder="" value="{{ old('partsproduct_uom', $partsproduct->partsproduct_uom) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_csrelease') is-invalid @enderror" id="partsproduct_csrelease" name="partsproduct_csrelease" type="text" placeholder="" value="{{ old('partsproduct_csrelease', $partsproduct->partsproduct_csrelease) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_csnumber') is-invalid @enderror" id="partsproduct_csnumber" name="partsproduct_csnumber" type="text" placeholder="" value="{{ old('partsproduct_csnumber', $partsproduct->partsproduct_csnumber) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_cenumber') is-invalid @enderror" id="partsproduct_cenumber" name="partsproduct_cenumber" type="text" placeholder="" value="{{ old('partsproduct_cenumber', $partsproduct->partsproduct_cenumber) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_ronumber') is-invalid @enderror" id="partsproduct_ronumber" name="partsproduct_ronumber" type="text" placeholder="" value="{{ old('partsproduct_ronumber', $partsproduct->partsproduct_ronumber) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('partsproduct_startdate') is-invalid @enderror" name="partsproduct_startdate" id="partsproduct_startdate" type="date" value="{{ old('partsproduct_startdate', $partsproduct->partsproduct_startdate) }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('partsproduct_enddate') is-invalid @enderror" name="partsproduct_enddate" id="partsproduct_enddate" type="date" value="{{ old('partsproduct_enddate', $partsproduct->partsproduct_enddate) }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('partsproduct_price') is-invalid @enderror" name="partsproduct_price" id="partsproduct_price" type="text" value="{{ old('partsproduct_price', $partsproduct->partsproduct_price) }}" autocomplete="off" />
