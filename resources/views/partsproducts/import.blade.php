...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('partsproducts.handleImport') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <!-- Import products -->
                <div class="card mb-4 mb-xl-0">
                    <div class="card-header">Import Product Spare Parts</div>
                    <div class="card-body">
