...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('unreproducts.update', $unreproduct->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <!-- Product image -->
                        <img class="img-account-profile mb-2" src="{{ $unreproduct->unreproduct_image ? asset($unreproduct->unreproduct_image) : asset('assets/img/products/default.webp') }}" alt="" id="image-preview" />
                        <!-- unreproduct image help block -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_assetID') is-invalid @enderror" id="unreproduct_assetID" name="unreproduct_assetID" type="text" placeholder="" value="{{ old('unreproduct_assetID', $unreproduct->unreproduct_assetID) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_newassetID') is-invalid @enderror" id="unreproduct_newassetID" name="unreproduct_newassetID" type="text" placeholder="" value="{{ old('unreproduct_newassetID', $unreproduct->unreproduct_newassetID) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_serial') is-invalid @enderror" id="unreproduct_serial" name="unreproduct_serial" type="text" placeholder="" value="{{ old('unreproduct_serial', $unreproduct->unreproduct_serial) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="unreproduct_transfer">Asset Transfer Ref. </label>
                                <input class="form-control form-control-solid @error('unreproduct_transfer') is-invalid @enderror" id="unreproduct_transfer" name="unreproduct_transfer" type="text" placeholder="" value="{{ old('unreproduct_transfer', $unreproduct->unreproduct_transfer) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_reser') is-invalid @enderror" id="unreproduct_reser" name="unreproduct_reser" type="text" placeholder="" value="{{ old('unreproduct_reser', $unreproduct->unreproduct_reser) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_origin') is-invalid @enderror" id="unreproduct_origin" name="unreproduct_origin" type="text" placeholder="" value="{{ old('unreproduct_origin', $unreproduct->unreproduct_origin) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_sdvin') is-invalid @enderror" id="unreproduct_sdvin" name="unreproduct_sdvin" type="text" placeholder="" value="{{ old('unreproduct_sdvin', $unreproduct->unreproduct_sdvin) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_sdvout') is-invalid @enderror" id="unreproduct_sdvout" name="unreproduct_sdvout" type="text" placeholder="" value="{{ old('unreproduct_sdvout', $unreproduct->unreproduct_sdvout) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_station') is-invalid @enderror" id="unreproduct_station" name="unreproduct_station" type="text" placeholder="" value="{{ old('unreproduct_station', $unreproduct->unreproduct_station) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_requestor') is-invalid @enderror" id="unreproduct_requestor" name="unreproduct_requestor" type="text" placeholder="" value="{{ old('unreproduct_requestor', $unreproduct->unreproduct_requestor) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_project') is-invalid @enderror" id="unreproduct_project" name="unreproduct_project" type="text" placeholder="" value="{{ old('unreproduct_project', $unreproduct->unreproduct_project) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('unreproduct_datein') is-invalid @enderror" name="unreproduct_datein" id="unreproduct_datein" type="date" placeholder="" value="{{ old('unreproduct_datein', $unreproduct->unreproduct_datein) }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('unreproduct_dateout') is-invalid @enderror" name="unreproduct_dateout" id="unreproduct_dateout" type="date" placeholder="" value="{{ old('unreproduct_dateout', $unreproduct->unreproduct_dateout) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('unreproduct_dateoffshore') is-invalid @enderror" name="unreproduct_dateoffshore" id="unreproduct_dateoffshore" type="date" value="{{ old('unreproduct_dateoffshore', $unreproduct->unreproduct_dateoffshore) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_tfoffshore') is-invalid @enderror" id="unreproduct_tfoffshore" name="unreproduct_tfoffshore" type="text" placeholder="" value="{{ old('unreproduct_tfoffshore', $unreproduct->unreproduct_tfoffshore) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_curloc') is-invalid @enderror" id="unreproduct_curloc" name="unreproduct_curloc" type="text" placeholder="" value="{{ old('unreproduct_curloc', $unreproduct->unreproduct_curloc) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('unreproduct_targetpdn') is-invalid @enderror" name="unreproduct_targetpdn" id="unreproduct_targetpdn" type="date" value="{{ old('unreproduct_targetpdn', $unreproduct->unreproduct_targetpdn) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_csnumber') is-invalid @enderror" id="unreproduct_csnumber" name="unreproduct_csnumber" type="text" placeholder="" value="{{ old('unreproduct_csnumber', $unreproduct->unreproduct_csnumber) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_cenumber') is-invalid @enderror" id="unreproduct_cenumber" name="unreproduct_cenumber" type="text" placeholder="" value="{{ old('unreproduct_cenumber', $unreproduct->unreproduct_cenumber) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_ronumber') is-invalid @enderror" id="unreproduct_ronumber" name="unreproduct_ronumber" type="text" placeholder="" value="{{ old('unreproduct_ronumber', $unreproduct->unreproduct_ronumber) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('unreproduct_startdate') is-invalid @enderror" name="unreproduct_startdate" id="unreproduct_startdate" type="date" value="{{ old('unreproduct_startdate', $unreproduct->unreproduct_startdate) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('unreproduct_enddate') is-invalid @enderror" name="unreproduct_enddate" id="unreproduct_enddate" type="date" value="{{ old('unreproduct_enddate', $unreproduct->unreproduct_enddate) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_price') is-invalid @enderror" name="unreproduct_price" id="unreproduct_price" type="text" value="{{ old('unreproduct_price', $unreproduct->unreproduct_price) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('unreproduct_remark') is-invalid @enderror" id="unreproduct_remark" name="unreproduct_remark" type="text" placeholder="" value="{{ old('unreproduct_remark', $unreproduct->unreproduct_remark) }}" autocomplete="off"/>
