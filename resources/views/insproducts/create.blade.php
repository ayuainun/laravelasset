...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('insproducts.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-4">
                <!-- Product image card-->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_assetID') is-invalid @enderror" id="insproduct_assetID" name="insproduct_assetID" type="text" placeholder="" value="{{ old('insproduct_assetID') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_newassetID') is-invalid @enderror" id="insproduct_newassetID" name="insproduct_newassetID" type="text" placeholder="" value="{{ old('insproduct_newassetID') }}" autocomplete="off"/>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('insproduct_instype') is-invalid @enderror" id="insproduct_instype" name="insproduct_instype" type="text" placeholder="" value="{{ old('insproduct_instype') }}" autocomplete="off"/>
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="insproduct_serial">Serial Number</span></label>
                                <input class="form-control form-control-solid @error('insproduct_serial') is-invalid @enderror" id="insproduct_serial" name="insproduct_serial" type="text" placeholder="" value="{{ old('insproduct_serial') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_transfer') is-invalid @enderror" id="insproduct_transfer" name="insproduct_transfer" type="text" placeholder="" value="{{ old('insproduct_transfer') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_reser') is-invalid @enderror" id="insproduct_reser" name="insproduct_reser" type="text" placeholder="" value="{{ old('insproduct_reser') }}" autocomplete="off"/>
                             ...
                             <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_origin') is-invalid @enderror" id="insproduct_origin" name="insproduct_origin" type="text" placeholder="" value="{{ old('insproduct_origin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_sdvin') is-invalid @enderror" id="insproduct_sdvin" name="insproduct_sdvin" type="text" placeholder="" value="{{ old('insproduct_sdvin') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_sdvout') is-invalid @enderror" id="insproduct_sdvout" name="insproduct_sdvout" type="text" placeholder="" value="{{ old('insproduct_sdvout') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_station') is-invalid @enderror" id="insproduct_station" name="insproduct_station" type="text" placeholder="" value="{{ old('insproduct_station') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_requestor') is-invalid @enderror" id="insproduct_requestor" name="insproduct_requestor" type="text" placeholder="" value="{{ old('insproduct_requestor') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_project') is-invalid @enderror" id="insproduct_project" name="insproduct_project" type="text" placeholder="" value="{{ old('insproduct_project') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('insproduct_datein') is-invalid @enderror" name="insproduct_datein" id="insproduct_datein" type="date" value="{{ old('insproduct_datein') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('insproduct_dateout') is-invalid @enderror" name="insproduct_dateout" id="insproduct_dateout" type="date" value="{{ old('insproduct_dateout') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small my-1" for="insproduct_dateoffshore">Date to offshore</label>
                                <input class="form-control form-control-solid example-date-input @error('insproduct_dateoffshore') is-invalid @enderror" name="insproduct_dateoffshore" id="insproduct_dateoffshore" type="date" value="{{ old('insproduct_dateoffshore') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_tfoffshore') is-invalid @enderror" id="insproduct_tfoffshore" name="insproduct_tfoffshore" type="text" placeholder="" value="{{ old('insproduct_tfoffshore') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_curloc') is-invalid @enderror" id="insproduct_curloc" name="insproduct_curloc" type="text" placeholder="" value="{{ old('insproduct_curloc') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <label class="small my-1" for="insproduct_targetpdn">Target PDN</label>
                                <input class="form-control form-control-solid example-date-input @error('insproduct_targetpdn') is-invalid @enderror" name="insproduct_targetpdn" id="insproduct_targetpdn" type="date" value="{{ old('insproduct_targetpdn') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_stockin') is-invalid @enderror" id="insproduct_stockin" name="insproduct_stockin" type="text" placeholder="" value="{{ old('insproduct_stockin') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_stockout') is-invalid @enderror" id="insproduct_stockout" name="insproduct_stockout" type="text" placeholder="" value="{{ old('insproduct_stockout') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_stockqty') is-invalid @enderror" id="insproduct_stockqty" name="insproduct_stockqty" type="text" placeholder="" value="{{ old('insproduct_stockqty') }}" autocomplete="off" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('insproduct_uom') is-invalid @enderror" id="insproduct_uom" name="insproduct_uom" type="text" placeholder="" value="{{ old('insproduct_uom') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_csrelease') is-invalid @enderror" id="insproduct_csrelease" name="insproduct_csrelease" type="text" placeholder="" value="{{ old('insproduct_csrelease') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_csnumber') is-invalid @enderror" id="insproduct_csnumber" name="insproduct_csnumber" type="text" placeholder="" value="{{ old('insproduct_csnumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_cenumber') is-invalid @enderror" id="insproduct_cenumber" name="insproduct_cenumber" type="text" placeholder="" value="{{ old('insproduct_cenumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_ronumber') is-invalid @enderror" id="insproduct_ronumber" name="insproduct_ronumber" type="text" placeholder="" value="{{ old('insproduct_ronumber') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('insproduct_startdate') is-invalid @enderror" name="insproduct_startdate" id="insproduct_startdate" type="date" value="{{ old('insproduct_startdate') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid example-date-input @error('insproduct_enddate') is-invalid @enderror" name="insproduct_enddate" id="insproduct_enddate" type="date" value="{{ old('insproduct_enddate') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_price') is-invalid @enderror" name="insproduct_price" id="insproduct_price" type="text" value="{{ old('insproduct_price') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid @error('insproduct_status') is-invalid @enderror" id="insproduct_status" name="insproduct_status" status="text" placeholder="" value="{{ old('insproduct_status') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-15">
                                ...
                                <input class="form-control form-control-solid @error('insproduct_remark') is-invalid @enderror" id="insproduct_remark" name="insproduct_remark" type="text" placeholder="" value="{{ old('insproduct_remark') }}" autocomplete="off"/>
