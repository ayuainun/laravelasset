    ...
    <div class="container-xl px-4">
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('autoproducts.import') }}" class="btn btn-success add-list my-1"><i class="fa-solid fa-file-import me-3"></i>Import</a>
                    <a href="{{ route('autoproducts.export') }}" class="btn btn-warning add-list my-1"><i class="fa-solid fa-file-arrow-down me-3"></i>Export</a>
                    <a href="{{ route('autoproducts.create') }}" class="btn btn-primary add-list my-1"><i class="fa-solid fa-plus me-3"></i>Add</a>
                    <a href="{{ route('autoproducts.index') }}" class="btn btn-danger add-list my-1"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
                            ...
                            <div class="form-group row align-items-center justify-content-between">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" id="search" class="form-control me-1" name="search" placeholder="Search autoproduct" value="{{ request('search') }}">
                        ...
                        <table class="table table-striped align-middle">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">@sortablelink('autoproduct_sdvin', 'SDV In')</th>
                                    <th scope="col">@sortablelink('autoproduct_sdvout', 'SDV Out')</th>
                                    <th scope="col">@sortablelink('autoproduct_station', 'Station')</th>
                                    <th scope="col">@sortablelink('autoproduct_requestor', 'Requestor')</th>
                                    <th scope="col">@sortablelink('autoproduct_project', 'Project')</th>
                                    <th scope="col">@sortablelink('autoproduct_dateout', 'Date Out')</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">{{ (($autoproducts->currentPage() * (request('row') ? request('row') : 10)) - (request('row') ? request('row') : 10)) + $loop->iteration  }}</th>
                                    <td>
                                    ...
                                    <td>{{ $autoproduct->autoproduct_sdvin }}</td>
                                    <td>{{ $autoproduct->autoproduct_sdvout }}</td>
                                    <td>{{ $autoproduct->autoproduct_station }}</td>
                                    <td>{{ $autoproduct->autoproduct_requestor }}</td>
                                    <td>{{ $autoproduct->autoproduct_project }}</td>
                                    ...
                                    <td>{{ $autoproduct->autoproduct_stockout }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('autoproducts.edit', $autoproduct->id) }}" class="btn btn-outline-primary btn-sm mx-1"><i class="fas fa-edit"></i></a>
                                            <form action="{{ route('autoproducts.destroy', $autoproduct->id) }}" method="POST">
                                                @method('delete')
                                                @csrf
