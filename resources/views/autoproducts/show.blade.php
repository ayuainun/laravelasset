...
<div class="container-xl px-2 mt-n10">
        <div class="row">
            <div class="col-xl-4">
                {{-- <div class="col-md-6">
                    <button class="btn btn-white"><i class="fa fa-print fa-lg"></i><a href="{{ route('autoproducts.pdf', ['id' => $autoproduct->id]) }}" target="_blank">Print PDF</a></button>
                </div> --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6"> 
                                ...
                                @if ($autoproduct->autoproduct_status)
                                <div class="form-control form-control-solid">{{ $autoproduct->autoproduct_status }}</div>
                                @else
